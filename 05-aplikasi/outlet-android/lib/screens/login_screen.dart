...
class _LoginScreenState extends State<LoginScreen> {
  final _email = TextEditingController(text: 'outlet-a@local.test');
            ...
            FadeUp(
              ...
              child: Column(
                children: [
                  ...
                  const Text(
                    'Akun uji: outlet-a@local.test / password123',
                    textAlign: TextAlign.center,
